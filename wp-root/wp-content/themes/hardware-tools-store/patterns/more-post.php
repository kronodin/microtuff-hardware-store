...
/**
 * Title: More Post
 * Slug: hardware-tools-store/more-post
 * Categories: hardware-tools-store, more-post
 */
?>
...
<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e('More Articles &amp; Posts','hardware-tools-store'); ?></h3>
<!-- /wp:heading -->
