 ...
 * Slug: hardware-tools-store/search-product
 * Categories: hardware-tools-store, search-product
 */
?>
...
<!-- wp:paragraph -->
<p><?php esc_html_e('No products were found matching your selection.','hardware-tools-store'); ?></p>
<!-- /wp:paragraph -->
