 ...
 * Slug: hardware-tools-store/index-header-image
 * Categories: hardware-tools-store, index-header-image
 */
?>
...
<h2 class="wp-block-heading has-text-align-center" style="text-transform:uppercase"><?php echo esc_html__('blog','hardware-tools-store'); ?></h2>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->