...
function hardware_tools_store_install_and_activate_plugins() {
    ...
    $redirect_url = admin_url('themes.php?page=hardware-tools-store-pro');
    echo json_encode([
        'success' => true,
        'data' => [
...
function hardware_tools_store_custom_admin_notice() {
    if (!get_option('dismissed-get_started_notice', false)) {
        ...
        if ($hardware_tools_store_current_screen && $hardware_tools_store_current_screen->id !== 'appearance_page_hardware-tools-store-pro') {
            ?>
            ...
            <div class="hardware-tools-store-admin-notice notice notice-info is-dismissible content-install-plugin theme-info-notice" id="hardware-tools-store-dismiss-notice" data-notice="get_started_notice">
                <div class="notice-div">
                    ...
                    <div class="notice-buttons-box">
                        ...
                        <button class="button-primary hardware-tools-store-notice-install-btn">
                            <span class="dashicons dashicons-download"></span>
                            <?php esc_html_e( 'Begin Installation', 'hardware-tools-store' ); ?>
                        </button>
                        <?php endif; ?>
                        <a class="button-primary getstarted" href="<?php echo esc_url( admin_url( 'themes.php?page=hardware-tools-store-pro' ) ); ?>" target="_blank"><?php esc_html_e('Theme Informations', 'hardware-tools-store'); ?></a>
                        ...
                        <a class="button-primary buynow" href="<?php echo esc_url( HARDWARE_TOOLS_STORE_BUY_PRO ); ?>" target="_blank"><?php esc_html_e('Get Pro Theme', 'hardware-tools-store'); ?></a>
                    </div>
                </div>
            </div>
            <?php
