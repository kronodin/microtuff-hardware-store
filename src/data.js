...
export const PRODUCTS = [
  ...
  { id: 9, name: 'Carib Cement 42.5kg', category: 'building', price: 18.99, icon: '🧱', desc: '42.5kg Carib cement bag — preferred for Jamaican masonry and concrete.', stock: 18, stockLabel: 'In Stock' },
  ...
  { id: 11, name: 'Steel Rod 1/2" x 20ft', category: 'building', price: 24.99, icon: '🔩', desc: '1/2 inch mild steel rod, 20ft — reinforcement and general construction.', stock: 14, stockLabel: 'In Stock' },
  { id: 12, name: 'Steel Rod 3/8" x 20ft', category: 'building', price: 16.99, icon: '🔩', desc: '3/8 inch mild steel rod, 20ft — lighter reinforcement jobs.', stock: 22, stockLabel: 'In Stock' },
